  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.footer}>
        <Pressable onPress={() => router.push('/notify-permission')} style={styles.kakaoButton}>
          <Text style={styles.kakaoText}>카카오로 시작하기</Text>
        </Pressable>
        
        <View style={styles.navigationButtons}>
          <Pressable onPress={() => router.push('/character-customize')} style={styles.navButton}>
            <Text style={styles.navButtonText}>캐릭터 꾸미기</Text>
          </Pressable>
          <Pressable onPress={() => router.push('/dashboard')} style={styles.navButton}>
