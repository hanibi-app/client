  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.headerArea}>
        <Text style={styles.headerMuted}>주의사항 2</Text>
      </View>
      ...
      <View style={styles.heroCard}>
        ...
        <View style={styles.square}>
          <View style={styles.circle}>
            <Text style={styles.circleText}>꼬질꼬질 디자인</Text>
          </View>
        </View>
      ...
      <View style={styles.contentArea}>
        <Text style={styles.title}>냄새가 날 땐 이렇게 해 주세요</Text>
        <Text style={styles.body}>
          뚜껑을 꼭 닫아 주시고,{"\n"}
          내부가 가득 찼다면 음식물을 비워 주세요.{"\n"}
          필터를 교체하거나 청소해 주시면 냄새가 줄어들어요.{"\n"}
          (임시 문구, 변경 해야함)
        </Text>
      </View>
      ...
      <View style={styles.footer}>
        ...
        <Pressable onPress={() => router.push('/caution/step3')} style={styles.nextFab}>
